                    ...
                    <div className={style.who__text}>
                        <div className={style.who__textContainer}>
                            <div className="textContainer">
                                <p className="text1">FIRMA</p>
                                <p className="text2">Kim jesteśmy</p>
                            </div>
                            <p className={style.text__desc}><span className={style.text__bigLeter}>J</span>esteśmy małą firmą programistyczną. Zajmujemy się tworzeniem <strong>stron internetowych</strong>, <strong>aplikacji webowych</strong> oraz <strong>serwisów internetowych</strong>. Przy tworzeniu projektów korzystamy z najnowszych i najczęściej używanych technologii, dlatego każdy projekt jest wysokiej jakości i stosunkowo tani w produkcji oraz utrzymaniu.<br /> <span className={style.text__bigLeter}>D</span>zięki nawiązaniu współpracy z innymi firmami i programistami jesteśmy w stanie tworzyć duże i skomplikowane projekty.</p>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div className={style.why__text}>
                        <div className={style.why__textContainer}>
                            <div className="textContainer text__white">
                                <p className="text1">USŁUGI</p>
                                <p className="text2 text__white">Dlaczego my?</p>
                            </div>
                            <p className={`${style.text__desc} ${style.text__white}`}><span className={style.text__bigLeter}>Z</span>ajmujemy się tworzeniem kompleksowych projektów od A do Z. Korzystamy z nowoczesnych rozwiązań, takich jak <strong>React</strong> i <strong>XaaS</strong>. Strony są projektowane jako <strong>RWD</strong> (<strong>Responsive Web Design</strong>) oraz <strong>PWA</strong> (<strong>Progressive Web Apps</strong>), dzięki czemu wyglądają dobrze na komputerze i na urządzeniu mobilnym. Każdy projekt jest przygotowany pod pozycjonowanie strony zgodnie z <strong>SEO</strong>.<br /> <span className={style.text__bigLeter}>C</span>ena też jest ważna. Nie trać pieniędzy zamawiając projekt w dużej firmie z ogromnymi kosztami utrzymania. U nas płacisz tylko za realnie spędzony czas nad projektem, a nie za utrzymanie całej infrastruktury. Zapytaj o wycenę, a się przekonasz.</p>
                        </div>
                    </div>
                    <figure className={style.figure__img}>
            ...
            <section className={style.approach}>
                <div className={style.approach__textContainer}>
                    <div data-aos="flip-left" className={style.approach__item}>
                        ...
                        <p className={style.approach__p}>Wszystkie projekty robimy w technologii RWD, dzięki czemu są dopasowane do rozdzielczości wszystkich urządzeń.  </p>
                    </div>
                    <div data-aos="flip-left" className={style.approach__item}>
                        <Quality />
                        <h2 className={style.approach__h2}>Jakość</h2>
                        <p className={style.approach__p}>Zawsze stawiamy na jakość. Nigdy nie idziemy na kompromis. Dzięki temu nasze produkty są łatwe w utrzymaniu i rozwoju. </p>
                    </div>
                    <div data-aos="flip-left" className={style.approach__item}>
                        <Aperance />
                        <h2 className={style.approach__h2}>Wygląd</h2>
                        <p className={style.approach__p}>Wygląd to sprawa priorytetowa. Każda zrobiona przez nas strona wygląda nowocześnie i jest niepowtarzalna.</p>
                    </div>
                    <div data-aos="flip-left" className={style.approach__item}>
                        <Tech />
                        <h2 className={style.approach__h2}>Technologia</h2>
                        <p className={style.approach__p}>Korzystamy z najnowszych technologii i stosujemy się do aktualnych trendów. Stale ulepszamy jakość swoich usług.</p>
                    </div>
                </div>
            </section>
            ...
            <section className={style.standards}>
                <div className={style.standards__container}>
                    <div className="textContainer marginLeftRight">
                        ...
                        <h1 className="text2">Standardy których używamy:</h1>
                    </div>
